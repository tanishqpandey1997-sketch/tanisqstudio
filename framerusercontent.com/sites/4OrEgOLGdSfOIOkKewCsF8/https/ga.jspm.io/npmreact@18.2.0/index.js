...
function M(e, r, n) {
    var o, u = {},
        ...
        c = null;
    if (null != r)
        for (o in void 0 !== r.ref && (c = r.ref), void 0 !== r.key && (a = "" + r.key), r) v.call(r, o) && !C.hasOwnProperty(o) && (u[o] = r[o]);
...
function R(e, n, o, u, a) {
    ...
    if (i) return i = e, a = a(i), e = "" === u ? "." + Q(i, 0) : u, h(a) ? (o = "", null != e && (o = e.replace(w, "$&/") + "/"), R(a, n, o, "", (function(e) {
        return e
    }))) : null != a && (O(a) && (a = N(a, o + (!a.key || i && i.key === a.key ? "" : ("" + a.key).replace(w, "$&/") + "/") + e)), n.push(a)), 1;
    i = 0;
    u = "" === u ? "." : u + ":";
    if (h(e))
        for (var f = 0; f < e.length; f++) {
            ...
            for (e = s.call(e), f = 0; !(c = e.next()).done;) c = c.value, s = u + Q(c, f++), i += R(c, n, o, s, a);
        else if ("object" === c) throw n = String(e), Error("Objects are not valid as a React child (found: " + ("[object Object]" === n ? "object with keys {" + Object.keys(e).join(", ") + "}" : n) + "). If you meant to render a collection of children, use an array instead.");
    return i
}
...
e.cloneElement = function(e, r, n) {
    ...
    if (null != r) {
        ...
        for (f in r) v.call(r, f) && !C.hasOwnProperty(f) && (o[f] = void 0 === r[f] && void 0 !== i ? i[f] : r[f])
    }
...
const j = e.Children,
    ...
    me = e.version;
export {
    j as Children, I as Component, x as Fragment, P as Profiler, D as PureComponent, V as StrictMode, L as Suspense, U as __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, q as cloneElement, z as createContext, B as createElement, H as createFactory, W as createRef, e as
    default, Y as forwardRef, J as isValidElement, K as lazy, X as memo, Z as startTransition, ee as unstable_act, te as useCallback, re as useContext, ne as useDebugValue, oe as useDeferredValue, ue as useEffect, ae as useId, ce as useImperativeHandle, ie as useInsertionEffect, fe as useLayoutEffect, se as useMemo, le as useReducer, pe as useRef, ye as useState, de as useSyncExternalStore, _e as useTransition, me as version
};
