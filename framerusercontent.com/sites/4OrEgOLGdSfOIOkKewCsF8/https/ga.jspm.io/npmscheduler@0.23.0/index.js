    ...
    if (t !== n) {
        ...
        e: for (var a = 0, l = e.length, r = l >>> 1; a < r;) {
            var i = 2 * (a + 1) - 1,
                ...
                o = i + 1,
                s = e[o];
            if (0 > g(u, t)) o < l && 0 > g(s, u) ? (e[a] = s, e[o] = t, a = o) : (e[a] = u, e[i] = t, a = i);
            else {
...
e.unstable_scheduleCallback = function(n, t, a) {
    ...
    a > u ? (n.sortIndex = a, f(r, n), null === h(l) && n === h(r) && (b ? (_(m), m = -1) : b = !0, K(H, a - u))) : (n.sortIndex = o, f(l, n), c || s || (c = !0, I(J)));
    return n
};
